...
$config = [
    ...
    'example-sql' => [
        'sqlauth:SQL',
        'dsn' => 'mysql:host=mariadb;port=5432;dbname=upo',
        'username' => '',
        'password' => '',
        'query' => 'SELECT identificador, nombre as gn, correo FROM alumnos WHERE identificador = :username ' .
            'AND password = SHA2(CONCAT((SELECT password FROM alumnos WHERE identificador = :username), :password), 256);',
    ],
